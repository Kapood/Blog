				...
				<el-row class="row">
					<el-col :xs="24" :md="12">
						<div class="intro__left bg-grey bg-grey--full-width">
							...
							<h2 class="intro__title">Kapood</h2>
							<p class="intro__about">Всем привет! Я начинающий веб-разработчик. Проживаю в городе Днепр. В 2018 году начал изучать веб-дизайн, но как только столкнулся с HTML5, понял, что это то чему хочу посвятить всего себя! Сейчас активно развиваюсь в области Front-end Development. В короткие сроки могу освоить и начать использовать новые технологии. Я целеустремлен и воодушевлен идей развития в IT. На данный момент ищу место, где смогу получить хорошие знания, невероятный опыт и отличную команду при работе над интересными проектами.</p>
						</div>
					...
					<el-col :xs="24" :md="12" class="col-6">
						<div class="intro__right">
							<div class="intro__photo">
								<img src="@/assets/about.jpg" alt="Kapood">
							</div>
						</div>
					</el-col>
				</el-row>
